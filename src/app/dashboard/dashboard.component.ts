...
export class DashboardComponent {
    ...
    //Donut Chart Config
    public donutChartLabels:string[] = ["Andhra pradesh", "Uttar pradesh", "Kashmir", "Madhya pradesh"];
    ...
    //Line Chart Config
    public lineChartLabels:Array<any> = ['January', 'February', 'March', 'April', 'May', 'June', 'July','August','September','October','Novenmber','December'];
    public lineChartData:Array<any> = [
        {data: [65, 59, 80, 81, 56, 55, 40, 37, 54, 76, 63, 62], label: 'Disease A'},
        {data: [28, 48, 40, 19, 86, 27, 90, 43, 65 ,76, 87, 85], label: 'Disease B'},
		{data: [38, 98, 60, 69, 76, 27, 50, 13, 25 ,36, 47, 65], label: 'Disease C'},
		
		{data: [38, 98, 10, 69, 16, 27, 10, 13, 25 ,36, 47, 32], label: 'Disease D'}
    ];
